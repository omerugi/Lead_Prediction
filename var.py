...
features_with_nan_map_to_other = ["How did you hear about X Education",
...
mappping_values = {'Lead Profile': 'Other Leads',
                   'City': 'Other Cities',
                   'TotalVisits': 3.445237833681204,
                   'Page Views Per Visit': 2.3628199494672093}
# TotalVisits,Page Views Per Visit == The mean value of the columns.
new_featuers_lst = ['Other',
                    'Multiple Sources',
                    "Social Media",
...
featuers_to_drop = ["Receive More Updates About Our Courses",
                                    "Lead Number",
                                    "City",
                                    "Last Activity",
                                    "Tags",
